...
CREATE TABLE "quiz_completion_marked_answer_option" (
	...
	CONSTRAINT "quiz_completion_marked_answer_option_answer_option_id_quiz_completion_id_pk" PRIMARY KEY("answer_option_id","quiz_completion_id")
);
--> statement-breakpoint
...
ALTER TABLE "quiz_completion_marked_answer_option" ADD CONSTRAINT "quiz_completion_marked_answer_option_answer_option_id_answer_option_id_fk" FOREIGN KEY ("answer_option_id") REFERENCES "public"."answer_option"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
